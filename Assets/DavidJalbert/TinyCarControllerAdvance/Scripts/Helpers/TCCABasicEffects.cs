            ...
            for (int i = 0; i < getWheels().Length; i++)
            {
                ...
                if (skidding)
                {
                    if (skidMarkObjects != null)
                    {
                        ...
                        skidMarkObjects[i].transform.position = wheel.transform.position + Vector3.down * wheel.getCollider().radius * 0.9f;
                    }
                ...
                if (smokeObjects != null) smokeObjects[i].transform.position = wheel.transform.position + Vector3.down * wheel.getCollider().radius * 0.9f;
            }
