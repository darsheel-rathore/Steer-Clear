...
public class ControllerSelf : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Debug.Log("CarController is " + (carController == null) + " null.");
        }
    ...
    {
        carController.setMotor(inV);
        carController.setSteering(inH);
        carController.setBoost(nitroBoost);
        carController.setHandbrake(handBrake);
    }


    #region Input Value Setters
    ...
    public void SethandBrakeValue(bool value)
    {
        handBrake = value;
    }
